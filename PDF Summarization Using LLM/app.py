...
def get_conversational_chain():
    ...
    prompt_template = """
    Answer the question as detailed as possible from the provided context,provide summary as accurate as possible, make sure to provide all the details, if the answer is not in
